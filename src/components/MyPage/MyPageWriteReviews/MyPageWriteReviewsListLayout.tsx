    ...
    return (
        <tr>
            ...
            {data?.review ? <td>
                ...
                <td>
                <div className={styles.reviewWriteButton} onClick={()=>{onClick(data);}}>
                    후기 작성하러가기
                </div>
            </td>}
        </tr>
...
export default function MyPageWriteReviewsListLayout({purchases, onClick}: MyPageWriteReviewsListLayoutParams) {
